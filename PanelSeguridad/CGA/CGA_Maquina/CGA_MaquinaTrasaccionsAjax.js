...
function transacionAjax_Maquina_create(State) {
    ...
    $.ajax({
        ...
        data: { "action": State,
            ...
            "Mfi": $("#DateStart_Matenimiento").val(),
            "Mff": $("#DateEnd_Matenimiento").val(),
            "Mhi": $("#TxtHI_Mantenimiento").val(),
            "Mhf": $("#TxtHF_Mantenimiento").val(),
            "NDfi": $("#DateStart_NODisponibilidad").val(),
            "NDff": $("#DateEnd_NODisponibilidad").val(),
            "NDhi": $("#TxtHI_NODisponibilidad").val(),
            "NDhf": $("#TxtHF_NODisponibilidad").val(),
            "largo": $("#TxtLargo").val(),
            "ancho": $("#TxtAncho").val(),
            "ED": $("#TxtEspesor_Diametro").val(),
